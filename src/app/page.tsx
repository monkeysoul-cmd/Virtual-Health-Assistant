...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-4 md:p-8 lg:p-12 w-full">
      <header className="w-full mx-auto text-center mb-8 md:mb-12">
      ...
      <div id="doctor-directory" className="w-full">
        <DoctorDirectory />
      </div>

      <footer className="w-full mx-auto text-center mt-12 md:my-16 text-sm text-muted-foreground">
