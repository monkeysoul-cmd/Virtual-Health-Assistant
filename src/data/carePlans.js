import { 
  TestTube, Pill, Stethoscope, HeartPulse, Brain, Bone, Activity, 
  FlaskConical, Microscope, Thermometer, Wind, Bandage, Heart, 
  Droplets, AirVent, Shield, Smile, Bug 
} from 'lucide-react';
...
export const testSuggestions = [
    {
        ...
        tests: [
            {
                name: 'Physical Exam',
                description: 'A doctor can often diagnose a cold based on signs and symptoms.',
                icon: Activity,
                recommended: true,
            },
            {
                name: 'Rapid Strep Test',
                description: 'If a severe sore throat is present, to rule out strep throat.',
                icon: TestTube,
            },
        ],
        icon: Thermometer,
    ...
    },
    {
        ...
        tests: [
            ...
            {
                name: 'MRI or CT Scan',
                description: 'May be used to rule out other serious causes of headaches.',
                icon: Brain,
            },
        ],
        icon: Brain,
        ...
        tests: [
            {
                ...
                description: 'Measured with a pressure cuff. Multiple readings are often needed for a diagnosis.',
                icon: Heart,
                recommended: true,
            },
            {
        ...
        tests: [
            {
                ...
                description: 'To identify bacteria, viruses, or parasites causing the infection.',
                icon: FlaskConical,
                recommended: true,
            },
            {
    ...
    },
    {
        ...
        tests: [
            {
                name: 'Physical Exam',
                description: 'A doctor will assess your range of motion, strength, and locate the source of the pain.',
                icon: Activity,
                recommended: true,
            },
            {
                name: 'X-ray or MRI',
                description: 'To rule out fractures, arthritis, or soft tissue injuries.',
                icon: Bone,
            },
        ],
        icon: Bone,
    },
    {
        ...
        tests: [
            {
                name: 'Skin Prick Test',
                description: 'To identify specific allergens that cause a reaction on your skin.',
                icon: TestTube,
                recommended: true,
            },
            {
                name: 'Blood Test (IgE)',
                description: 'Measures the level of specific allergy-causing antibodies in your blood.',
                icon: Microscope,
            },
        ],
        icon: Wind,
    },
    {
        ...
        tests: [
            {
                name: 'Physical Exam',
                description: 'A doctor can usually diagnose tendonitis based on a physical exam and your symptoms.',
                icon: Activity,
                recommended: true,
            },
            {
                name: 'Ultrasound or MRI',
                description: 'To see inflammation or damage to the tendon.',
                icon: Bone,
            },
        ],
        icon: Bandage,
        ...
        tests: [
            {
                ...
                description: 'A doctor will review your symptoms and habits. This is often enough for diagnosis.',
                icon: Activity,
                recommended: true,
            },
            {
                name: 'Upper Endoscopy',
                description: 'May be recommended if symptoms are severe or persistent, to check for ulcers or GERD.',
                icon: Stethoscope,
            },
        ],
        icon: Shield,
    },
    {
        ...
        tests: [
            {
                name: 'Physical Exam & History',
                description: 'Review of your symptoms, diet, and bowel habits is the first step.',
                icon: Activity,
                recommended: true,
            },
            {
                name: 'Blood Test',
                description: 'To check for underlying conditions like an underactive thyroid.',
                icon: TestTube,
            },
        ],
        icon: Shield,
